...
//    }
    ...
    public void populateTimeline() {
        ...
        Recipe r1 = new Recipe("Peaches", "good fruit", u1, null, 200);
        Recipe r2 = new Recipe("Pasta", "with pesto alfredo sauce", u2, null, 300);
        Recipe r3 = new Recipe("Shrimp", "mmmmmmm", u3, null, 220);
        Recipe r4 = new Recipe("Bananas", "yellow fruit", u4, null, 400);
